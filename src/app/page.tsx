...
export default function HomePage() {
  return (
    <>
      ...
      {/* ═══════════════════════════════════════════
          10b. FREE ASSESSMENT CTA
          Lead capture via free assessment
      ═══════════════════════════════════════════ */}
      <section style={{ background: "#F3F0FF" }} className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <div
            className="rounded-2xl px-8 py-14 md:px-14 text-center"
          ...
          >
            ...
            <div
              ...
              style={{ background: "linear-gradient(180deg, #2D1B69 0%, #1A0F3C 100%)" }}
            >
              <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
              </svg>
            </div>
            ...
            <h2
              className="font-bold leading-tight mb-4"
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", color: "#2D1B69" }}
            >
              Discover Your Life Skills Profile
            </h2>

            <p
              className="leading-relaxed mx-auto mb-9"
              style={{ color: "#6B6B6B", fontFamily: "var(--font-body)", fontSize: "1.0625rem", maxWidth: "480px" }}
            >
              Answer a few structured questions and receive a personalised pathway recommendation - matched to exactly where you are today. No guesswork. No generic advice.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact" className="btn-premium-dark">
